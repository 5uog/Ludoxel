...
DECORATIVE_STONE_TYPES: tuple[StoneType, ...] = (
  ...
  StoneType(key="mossy_stone_bricks", display="Mossy Stone Bricks", textures=cube_textures("stone_brick_mossy"), slab_key="mossy_stone_brick_slab", stairs_key="mossy_stone_brick_stairs", wall_key="mossy_stone_brick_wall"),
