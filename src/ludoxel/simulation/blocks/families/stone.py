...
from ludoxel.simulation.blocks.sounds.groups import DEFAULT_BLOCK_SOUND_GROUP, SOUND_GROUP_BASALT, SOUND_GROUP_DEEPSLATE, SOUND_GROUP_TUFF
...
STONE_TYPES: tuple[StoneType, ...] = (
  ...
  StoneType(key="deepslate", display="Deepslate", textures=side_top_bottom_textures("deepslate", "deepslate_top", "deepslate_top"), sound_group=SOUND_GROUP_DEEPSLATE, tags=(PILLAR_AXIS_TAG,)),
  ...
  StoneType(key="basalt", display="Basalt", textures=column_textures("basalt_side", "basalt_top"), sound_group=SOUND_GROUP_BASALT, tags=(PILLAR_AXIS_TAG,)),
  ...
  StoneType(key="polished_basalt", display="Polished Basalt", textures=column_textures("polished_basalt_side", "polished_basalt_top"), sound_group=SOUND_GROUP_BASALT, tags=(PILLAR_AXIS_TAG,)),
