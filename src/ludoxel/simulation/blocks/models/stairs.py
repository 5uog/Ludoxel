...
from ludoxel.simulation.blocks.structures.cardinal import cardinal_turns_from_facing
from ludoxel.simulation.blocks.structures.structural_rules import is_stairs
