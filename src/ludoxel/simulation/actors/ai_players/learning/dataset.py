...
RECORD_KINDS: tuple[str, ...] = (RECORD_PLAYER_MOVEMENT, RECORD_PLAYER_COMBAT, RECORD_PLAYER_BLOCK_PLACEMENT, RECORD_PLAYER_BLOCK_BREAKING, RECORD_PLAYER_PARKOUR, RECORD_PLAYER_TRAP, RECORD_AI_DECISIONS, RECORD_AI_FAILURES, RECORD_AI_DEATHS, RECORD_AI_ROUTE_FAILURES, RECORD_AI_ESCAPE_ATTEMPTS)
