...
from ludoxel.shared.math.chunking.chunking_chunk_grid import ChunkKey
from ludoxel.shared.math.math_vec3 import Vec3
from ludoxel.shared.opengl.compute.compute_chunk_face_payload_builder import ChunkFacePayloadBuilder
...
from ludoxel.shared.opengl.passes.passes_selection_pass import SelectionPass
...
from ludoxel.shared.opengl.passes.passes_world_pass import WorldPass
from ludoxel.shared.opengl.pipeline.pipeline_frame_pipeline import FramePipeline
from ludoxel.shared.opengl.runtime.runtime_block_visual_resolver import BlockVisualResolver
from ludoxel.shared.opengl.runtime.runtime_gl_info_probe import GLInfoSnapshot, probe_gl_info
from ludoxel.shared.opengl.runtime.runtime_gl_renderer_params import GLRendererParams
from ludoxel.shared.opengl.runtime.runtime_gl_resources import GLResources
from ludoxel.shared.opengl.runtime.runtime_render_metrics import RendererFrameMetrics
...
from ludoxel.shared.opengl.runtime.runtime_texture_animation_controller import TextureAnimationController
from ludoxel.shared.rendering.faces.faces_face_bucket_layout import BucketCounts
...
from ludoxel.shared.rendering.rendering_selection_outline_builder import SelectionOutlineBuilder
...
class RendererBackend:
  ...
  def initialize(self, assets_dir: Path, *, block_registry: BlockRegistry) -> None:
    ...
    self._pipeline = FramePipeline(
      ...
      falling_block_pass=self._falling_blocks,
      block_break_particle_pass=self._block_break_particles,
