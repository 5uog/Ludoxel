...
def __getattr__(name: str):
  ...
  if str(name) in {"CameraParams", "ShadowParams", "SunParams", "CloudParams", "SkyParams", "GLRendererParams", "default_gl_renderer_params"}:
    from ludoxel.shared.opengl.runtime.runtime_gl_renderer_params import CameraParams, CloudParams, GLRendererParams, ShadowParams, SkyParams, SunParams, default_gl_renderer_params
  ...
  if str(name) == "build_chunk_mesh_cpu":
    from ludoxel.shared.rendering.faces.faces_chunk_face_payload_cpu import build_chunk_mesh_cpu
