...
# FILE: src/ludoxel/shared/presentation/opengl/passes/world_pass.py
...
from ....application.rendering.chunk_selection import select_visible_chunks, within_render_distance
