...
# FILE: src/ludoxel/shared/presentation/opengl/runtime/gl_resources.py
...
class GLResources:
    ...
    def load(assets_dir: Path, *, blocks: BlockRegistry) -> "GLResources":
        ...
        othello_shader_dir = Path(__file__).resolve().parents[4] / "features" / "othello" / "presentation" / "opengl" / "shaders"
