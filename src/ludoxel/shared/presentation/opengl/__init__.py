...
# FILE: src/ludoxel/shared/presentation/opengl/__init__.py
...
def __getattr__(name: str):
    ...
    if str(name) in {"CameraParams", "ShadowParams", "SunParams", "CloudParams", "SkyParams", "GLRendererParams", "default_gl_renderer_params"}:
        from ludoxel.shared.presentation.opengl.runtime.gl_renderer_params import CameraParams, CloudParams, GLRendererParams, ShadowParams, SkyParams, SunParams, default_gl_renderer_params
    ...
    if str(name) == "build_chunk_mesh_cpu":
        from ludoxel.shared.application.rendering.chunk_face_payload_cpu import build_chunk_mesh_cpu
