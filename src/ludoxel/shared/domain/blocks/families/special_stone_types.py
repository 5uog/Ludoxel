...
# FILE: src/ludoxel/shared/domain/blocks/families/special_stone_types.py
...
SPECIAL_STONE_TYPES: tuple[StoneType, ...] = (
    ...
    StoneType(key="gold_block", display="Block of Gold", textures=cube_textures("gold_block"), sound_group=SOUND_GROUP_METAL),
    StoneType(key="emerald_block", display="Block of Emerald", textures=cube_textures("emerald_block"), sound_group=SOUND_GROUP_METAL),
    StoneType(key="diamond_block", display="Block of Diamond", textures=cube_textures("diamond_block"), sound_group=SOUND_GROUP_METAL),
    ...
    StoneType(key="calcite", display="Calcite", textures=cube_textures("calcite"), sound_group=SOUND_GROUP_CALCITE),
    ...
    StoneType(key="gilded_blackstone", display="Gilded Blackstone", textures=cube_textures("gilded_blackstone"), sound_group=SOUND_GROUP_GILDED_BLACKSTONE),
)
