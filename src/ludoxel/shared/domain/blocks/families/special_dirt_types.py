...
# FILE: src/ludoxel/shared/domain/blocks/families/special_dirt_types.py
...
SPECIAL_DIRT_TYPES: tuple[StoneType, ...] = (
    ...
    StoneType(key="gravel", display="Gravel", textures=cube_textures("gravel"), sound_group=SOUND_GROUP_GRAVEL),
    StoneType(key="sand", display="Sand", textures=cube_textures("sand"), sound_group=SOUND_GROUP_SAND),
    StoneType(key="red_sand", display="Red Sand", textures=cube_textures("red_sand"), sound_group=SOUND_GROUP_SAND),
)
