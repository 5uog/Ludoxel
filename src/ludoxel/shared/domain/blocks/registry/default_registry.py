...
# FILE: src/ludoxel/shared/domain/blocks/registry/default_registry.py
...
def _build_default_registry() -> BlockRegistry:
    ...
    from ..catalog.planks import register_wood_blocks
    from ..catalog.stones import register_stones
