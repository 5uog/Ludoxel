...
from ludoxel.shared.blocks.structure.structure_connectivity import make_fence_gate_state, make_wall_state
from ludoxel.shared.blocks.structure.structure_structural_rules import is_fence_gate, is_slab, is_stairs, is_wall
