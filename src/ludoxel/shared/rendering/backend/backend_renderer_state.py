...
from ludoxel.shared.math.math_view_angles import sun_dir_from_az_el_deg
...
def normalize_backend_cloud_flow_direction(raw: str) -> str:
  s = str(raw).strip().lower()
  if s in BACKEND_CLOUD_FLOW_DIRECTIONS:
    return s
