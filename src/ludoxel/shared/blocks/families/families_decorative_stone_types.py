...
from ludoxel.shared.blocks.blocks_sound_groups import SOUND_GROUP_DEEPSLATE_BRICKS, SOUND_GROUP_TUFF
...
DECORATIVE_STONE_TYPES: tuple[StoneType, ...] = (
  ...
  StoneType(
    key="end_stone_bricks", display="End Stone Bricks", textures=cube_textures("end_bricks"), slab_key="end_stone_brick_slab", stairs_key="end_stone_brick_stairs", wall_key="end_stone_brick_wall"
  ),
  StoneType(
  ...
  StoneType(
    ...
    sound_group=SOUND_GROUP_DEEPSLATE_BRICKS,
  ),
  ...
  StoneType(
    ...
    textures=side_top_bottom_textures("chiseled_tuff_bricks", "chiseled_tuff_bricks_top", "chiseled_tuff_bricks_top"),
    sound_group=SOUND_GROUP_TUFF,
  ),
)
