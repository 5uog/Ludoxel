...
from ludoxel.shared.blocks.structure.structure_cardinal import cardinal_turns_from_facing
from ludoxel.shared.blocks.structure.structure_structural_rules import is_stairs
