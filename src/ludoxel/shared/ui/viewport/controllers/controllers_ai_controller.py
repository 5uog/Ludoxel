...
from ludoxel.application.runtime.runtime_ai_player_types import AI_MODE_IDLE, AI_MODE_ROUTE, AiRoutePoint, AiSpawnEggSettings
...
from ludoxel.shared.systems.systems_interaction_service import InteractionOutcome
from ludoxel.shared.ui.common.common_themed_notice_dialog import show_themed_notice
from ludoxel.shared.ui.hud.hud_route_overlay_widget import RouteOverlayPath
from ludoxel.shared.ui.overlays.overlays_ai_settings_overlay import AiSettingsOverlay
from ludoxel.shared.world.inventory.inventory_core_special_items import AI_ROUTE_CANCEL_ITEM_ID, AI_ROUTE_CONFIRM_ITEM_ID, AI_ROUTE_ERASE_ITEM_ID, AI_SPAWN_EGG_ITEM_ID
