...
from ludoxel.application.runtime.runtime_keybinds import ACTION_TOGGLE_INVENTORY, KeybindSettings, action_for_key
from ludoxel.shared.blocks.registry.registry_block_registry import BlockRegistry
from ludoxel.shared.world.inventory.inventory_hotbar import HOTBAR_SIZE, normalize_hotbar_index, normalize_hotbar_slots
from ludoxel.shared.world.inventory.inventory_special_items import iter_catalog_special_items
