...
from ludoxel.features.othello.domain.inventory.inventory_special_items import iter_othello_special_item_descriptors
from ludoxel.shared.world.inventory.inventory_core_special_items import iter_core_special_item_descriptors
