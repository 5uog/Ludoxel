...
class SessionManager:
  ...
  def place_block_from_hit(self, hit, block_id: str | None, *, forced_place_state: str | None = None, inherit_state: str | None = None):
    return place_block_from_hit_for_session(self, hit, block_id, forced_place_state=forced_place_state, inherit_state=inherit_state)
