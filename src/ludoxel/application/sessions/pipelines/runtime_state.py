...
def runtime_preferences_from_app_state(state: AppState | None, *, runtime: RuntimePreferences | None = None) -> RuntimePreferences:
  ...
  out = coerce_runtime_preferences(
    ...
    block_interact_repeat_interval_s=float(settings.block_interact_repeat_interval_s),
    block_break_particle_spawn_rate=float(settings.block_break_particle_spawn_rate),
    block_break_particle_speed_scale=float(settings.block_break_particle_speed_scale),
    ...
    crosshair_mode=str(settings.crosshair_mode),
    crosshair_pixels=tuple(settings.crosshair_pixels),
    player_skin_kind=str(settings.player_skin_kind),
    camera_perspective=str(settings.camera_perspective),
    ...
    arm_rotation_limit_min_deg=float(settings.arm_rotation_limit_min_deg),
    arm_rotation_limit_max_deg=float(settings.arm_rotation_limit_max_deg),
    arm_swing_duration_s=float(settings.arm_swing_duration_s),
    animated_textures_enabled=bool(settings.animated_textures_enabled),
    debug_shadow=bool(settings.debug_shadow),
    vsync_on=bool(settings.vsync_on),
    hud_visible=bool(settings.hud_visible),
    window_left=settings.window_left,
    window_top=settings.window_top,
    ...
    creative_upper_slots=list(inventory.creative_upper_slots),
    ...
    survival_upper_slots=list(inventory.survival_upper_slots),
...
def persisted_inventory_from_runtime(runtime: RuntimePreferences) -> PersistedInventory:
  ...
  return PersistedInventory(
    ...
    creative_upper_slots=tuple(runtime.creative_upper_slots),
    ...
    survival_upper_slots=tuple(runtime.survival_upper_slots),
