...
CLOUD_CELL_SIZE_MIN: int = 8
CLOUD_CELL_SIZE_MAX: int = 40
DEFAULT_CLOUD_CELL_SIZE: int = 20

CLOUD_Y_MIN: int = 28
CLOUD_Y_MAX: int = 250
DEFAULT_CLOUD_HEIGHT_VARIATION_ENABLED: bool = True
DEFAULT_CLOUD_FIXED_Y: int = 128
DEFAULT_CLOUD_SPAWN_Y_MIN: int = 128
DEFAULT_CLOUD_SPAWN_Y_MAX: int = 135
DEFAULT_CLOUD_PREFERRED_Y_MIN: int = 128
DEFAULT_CLOUD_PREFERRED_Y_MAX: int = 130
DEFAULT_CLOUD_PREFERRED_Y_PROBABILITY_PERCENT: int = 70


def normalize_cloud_cell_size(value: object) -> int:
