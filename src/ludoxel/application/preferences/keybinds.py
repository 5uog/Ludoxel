...
ACTION_TOGGLE_CHAT = "toggle_chat"
...
CONTROL_SECTION_GAMEPLAY: tuple[str, ...] = (ACTION_TOGGLE_INVENTORY, ACTION_TOGGLE_CHAT, ACTION_CYCLE_CAMERA_PERSPECTIVE, ACTION_TOGGLE_GAMEPLAY_HUD, ACTION_CLEAR_SELECTED_SLOT, ACTION_TOGGLE_DEBUG_HUD, ACTION_TOGGLE_DEBUG_SHADOW)
