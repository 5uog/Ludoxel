...
CAMERA_PERSPECTIVE_LABELS: dict[str, str] = {
  CAMERA_PERSPECTIVE_FIRST_PERSON: "First Person",
  CAMERA_PERSPECTIVE_THIRD_PERSON_BACK: "Third Person Back",
  CAMERA_PERSPECTIVE_THIRD_PERSON_FRONT: "Third Person Front",
}
