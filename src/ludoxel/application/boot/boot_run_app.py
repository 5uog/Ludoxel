...
from ludoxel.shared.shared_project_paths import default_project_root, default_resource_root, default_runtime_data_root, is_frozen_application
...
def run_app() -> None:
  ...
  from ludoxel.shared.ui.ui_main_window import run_app as _run
