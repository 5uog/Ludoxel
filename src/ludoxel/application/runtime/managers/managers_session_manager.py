...
from ludoxel.application.runtime.managers.managers_ai_player_manager import AiLocalAttackResult, AiPlayerManager, AiRoutePathSnapshot
from ludoxel.application.runtime.managers.managers_player_combat import MELEE_ATTACK_REACH_BLOCKS, apply_void_damage, attack_sprinting
from ludoxel.application.runtime.managers.managers_player_kinematics import (
  PLAYER_WALK_MAX_SWING_SCALE,
  PlayerMotionState,
  PlayerStepInput,
  advance_runtime_player,
  build_player_model_snapshot,
  fall_damage_amount,
)
from ludoxel.application.runtime.runtime_ai_player_types import AiPlayerState, AiSpawnEggSettings
...
from ludoxel.shared.rendering.rendering_render_snapshot import CameraDTO, FallingBlockRenderSampleDTO, RenderSnapshotDTO
from ludoxel.shared.systems.systems_collision_system import SupportBlockContact, support_block_beneath
from ludoxel.shared.systems.systems_gravity_system import GravityBrokenBlock, GravitySystem
