...
from ludoxel.features.othello.domain.game.game_board import square_index_to_row_col
from ludoxel.features.othello.domain.game.game_rules import apply_move, counts_for_board, create_initial_board, find_legal_moves, winner_for_board
