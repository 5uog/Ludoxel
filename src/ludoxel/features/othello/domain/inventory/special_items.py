...
_SPECIAL_ITEMS: dict[str, SpecialItemDescriptor] = {
    OTHELLO_START_ITEM_ID: SpecialItemDescriptor(
        item_id=OTHELLO_START_ITEM_ID, 
        display_name="Start", 
        icon_key="start", 
        description="Start or restart the Othello match with the saved settings."
    ), 
    OTHELLO_SETTINGS_ITEM_ID: SpecialItemDescriptor(
        item_id=OTHELLO_SETTINGS_ITEM_ID, 
        display_name="Settings", 
        icon_key="settings", 
        description="Open the Othello configuration dialog for the next match."
    )
}
