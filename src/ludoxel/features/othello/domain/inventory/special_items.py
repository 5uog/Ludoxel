...
# FILE: src/ludoxel/features/othello/domain/inventory/special_items.py
...
_SPECIAL_ITEMS: dict[str, SpecialItemDescriptor] = {
    ...
    OTHELLO_SETTINGS_ITEM_ID: SpecialItemDescriptor(item_id=OTHELLO_SETTINGS_ITEM_ID, display_name="Settings", icon_key="settings", description="Open the Othello configuration dialog for the next match.")
}
