...
def bundled_opening_book_file_path() -> Path:
    """I define P_b as the immutable packaged opening-book path. This location stores the bundled baseline that I treat as read-only application data."""
...
def _load_bundled_opening_book_lines_cached() -> tuple[tuple[int, ...], ...]:
    ...
    return _read_lines_from_path(bundled_opening_book_file_path())
