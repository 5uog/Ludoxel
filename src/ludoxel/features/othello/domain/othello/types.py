...
# FILE: src/ludoxel/features/othello/domain/othello/types.py
...
class OthelloGameState:
    ...
    def normalized(self) -> "OthelloGameState":
        ...
        return OthelloGameState(
            status=str(status), 
            board=decode_board(encode_board(self.board)), 
            settings=settings, 
            ...
            winner=winner, message=str(self.message), 
    ...
    def from_dict(data: dict[str, Any]) -> "OthelloGameState":
        ...
        return OthelloGameState(
            ...
            board=decode_board(data.get("board", "")), 
            settings=settings, 
