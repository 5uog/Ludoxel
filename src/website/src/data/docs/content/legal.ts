...
export const legalPages: DocsPageContent[] = [
  ...
  defineDocsArticle({
    ...
    description:
      'Explains the relationship between public summaries and the legal text. This page treats license interpretation as a public legal-orientation guide that points to controlling text without expanding it, identifies the owner that controls the result, and separates observable evidence from adjacent topics such as persistence, distribution, support routing, and legal authority.',
    sections: [
      {
        id: 'understanding-controlling-text-authority-scope',
        title: 'Controlling Text Authority Scope',
        body: [
          'The English license text controls Ludoxel original materials. Other explanatory pages are orientation material and should be consistent with that text. That reading gives Understanding Controlling Text a public anchor for authority scope without adding behavior that the current category does not own. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Authority Scope.',
          'Authority Scope defines the useful size of Understanding Controlling Text. The article should be broad enough to explain license interpretation, but narrow enough that expanding permissions through explanatory wording remains outside the conclusion.',
          'If the available evidence for authority scope does not identify the root LICENSE, third-party license files, public policy files, issue templates, and controlling legal text, Understanding Controlling Text should be treated as an observation rather than a confirmed cause.',
        ],
      },
      {
        id: 'understanding-controlling-text-controlling-text',
        title: 'Controlling Text Controlling Text',
        body: [
          'Authority Scope defines the useful size of Understanding Controlling Text. The article should be broad enough to explain license interpretation, but narrow enough that expanding permissions through explanatory wording remains outside the conclusion. The point matters in controlling text because reading rights from controlling text can otherwise be mistaken for expanding permissions through explanatory wording. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Controlling Text.',
          'A direct observation for Understanding Controlling Text should name what the user or reader actually sees before it assigns cause. That keeps the exact public legal text, affected material category, proposed use, restriction, third-party status, and whether the question concerns ordinary use or a restricted use ahead of guesses about hidden state.',
          'Understanding Controlling Text should not use controlling text to infer permission, release status, hidden routes, accepted contributions, or private security handling beyond the controlling public text.',
        ],
      },
      {
        id: 'understanding-controlling-text-material-class',
        title: 'Controlling Text Material Class',
        body: [
          'If the available evidence for authority scope does not identify the root LICENSE, third-party license files, public policy files, issue templates, and controlling legal text, Understanding Controlling Text should be treated as an observation rather than a confirmed cause. In Understanding Controlling Text, material class is the difference between reading license interpretation and assuming authority from a nearby surface, file, or policy summary. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Material Class.',
          'Understanding Controlling Text separates the surface that accepts input from the component or document that controls the result. This is especially important when reading rights from controlling text crosses a saved value, a renderer output, or a public form.',
          'If the available evidence for material class does not identify the root LICENSE, third-party license files, public policy files, issue templates, and controlling legal text, Understanding Controlling Text should be treated as an observation rather than a confirmed cause.',
        ],
      },
      {
        id: 'understanding-controlling-text-ordinary-use',
        title: 'Controlling Text Ordinary Use',
        body: [
          'Understanding Controlling Text should be read as conceptual boundary for controlling text within License Authority and Materials and Authority Text. The fact also tells the reader which evidence to preserve for ordinary use: the exact public legal text, affected material category, proposed use, restriction, third-party status, and whether the question concerns ordinary use or a restricted use. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Ordinary Use.',
          'Ownership in Understanding Controlling Text is not the same as display. A consumer can show, store, or report a value while the controlling boundary remains the root LICENSE, third-party license files, public policy files, issue templates, and controlling legal text.',
          'Use ordinary use to keep Understanding Controlling Text tied to License Authority and Materials; use a related page only when the reader needs a different owner.',
        ],
      },
      {
        id: 'understanding-controlling-text-restricted-use',
        title: 'Controlling Text Restricted Use',
        body: [
          'A direct observation for Understanding Controlling Text should name what the user or reader actually sees before it assigns cause. That keeps the exact public legal text, affected material category, proposed use, restriction, third-party status, and whether the question concerns ordinary use or a restricted use ahead of guesses about hidden state. For Understanding Controlling Text, that fact identifies the first concrete boundary for restricted use: the root LICENSE, third-party license files, public policy files, issue templates, and controlling legal text. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Restricted Use.',
          'Visible feedback for Understanding Controlling Text should be read as evidence, not as a complete diagnosis. The next step is to connect the feedback to the owner and to the category path Legal / License Authority and Materials / Authority Text.',
          'A public report based on the restricted use part of Understanding Controlling Text should state the action, expected result, actual result, environment, and any redaction needed before sharing.',
        ],
      },
      {
        id: 'understanding-controlling-text-third-party-split',
        title: 'Controlling Text Third-Party Split',
        body: [
          'Understanding Controlling Text should not use controlling text to infer permission, release status, hidden routes, accepted contributions, or private security handling beyond the controlling public text. The point matters in third-party split because reading rights from controlling text can otherwise be mistaken for expanding permissions through explanatory wording. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Third-Party Split.',
          'When Understanding Controlling Text touches saved data, the article should distinguish saved state, cache state, package resources, and public policy text. Those categories can interact, but they do not become the same authority.',
          'Understanding Controlling Text should not use third-party split to infer permission, release status, hidden routes, accepted contributions, or private security handling beyond the controlling public text.',
        ],
      },
      {
        id: 'understanding-controlling-text-public-summary-limit',
        title: 'Controlling Text Public Summary Limit',
        body: [
          'A summary can identify where to look, but it cannot replace definitions, conditions, restrictions, warranty language, jurisdiction, or distribution authority. In Understanding Controlling Text, material class is the difference between reading license interpretation and assuming authority from a nearby surface, file, or policy summary. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Material Class. That reading gives Understanding Controlling Text a public anchor for public summary limit without adding behavior that the current category does not own. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Public Summary Limit.',
          'The surrounding context for Understanding Controlling Text decides which adjacent topic is relevant. Understanding Controlling Text should be compared with Understanding License Authority, Including License Text, Understanding Original Materials only when the reader has moved to that neighboring subject. The related article should answer the new question instead of rewriting this one.',
          'If the available evidence for public summary limit does not identify the root LICENSE, third-party license files, public policy files, issue templates, and controlling legal text, Understanding Controlling Text should be treated as an observation rather than a confirmed cause.',
        ],
      },
      {
        id: 'understanding-controlling-text-reporting-limit',
        title: 'Controlling Text Reporting Limit',
        body: [
          'Understanding Controlling Text separates the surface that accepts input from the component or document that controls the result. This is especially important when reading rights from controlling text crosses a saved value, a renderer output, or a public form. For Understanding Controlling Text, that fact identifies the first concrete boundary for reporting limit: the root LICENSE, third-party license files, public policy files, issue templates, and controlling legal text. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Reporting Limit.',
          'Recovery or follow-up for Understanding Controlling Text should stay inside the same boundary as the failure. A settings mistake needs settings evidence, a data mistake needs data evidence, and a support or legal issue needs the matching public route.',
          'When Understanding Controlling Text crosses from reporting limit into saved data, output, packaging, support, or legal interpretation, the reader should name that crossing instead of flattening the categories.',
        ],
      },
      {
        id: 'understanding-controlling-text-distribution-limit',
        title: 'Controlling Text Distribution Limit',
        body: [
          'If the available evidence for material class does not identify the root LICENSE, third-party license files, public policy files, issue templates, and controlling legal text, Understanding Controlling Text should be treated as an observation rather than a confirmed cause. The point matters in distribution limit because reading rights from controlling text can otherwise be mistaken for expanding permissions through explanatory wording. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Distribution Limit.',
          'The main confusion risk in Understanding Controlling Text is expanding permissions through explanatory wording. The article avoids that risk by naming the owner, the evidence, and the public limit before it describes the result.',
          'Understanding Controlling Text should not use distribution limit to infer permission, release status, hidden routes, accepted contributions, or private security handling beyond the controlling public text.',
        ],
      },
      {
        id: 'understanding-controlling-text-ai-use-limit',
        title: 'Controlling Text AI Use Limit',
        body: [
          'The relevant state is constrained by the article category: Legal treats this topic as license and public-policy orientation. For Understanding Controlling Text, that fact identifies the first concrete boundary for ai use limit: the root LICENSE, third-party license files, public policy files, issue templates, and controlling legal text. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / AI Use Limit.',
          'Reportable evidence for Understanding Controlling Text should be small, concrete, and public. the exact public legal text, affected material category, proposed use, restriction, third-party status, and whether the question concerns ordinary use or a restricted use is more useful than a broad conclusion because another reader can compare those facts directly.',
          'When Understanding Controlling Text crosses from ai use limit into saved data, output, packaging, support, or legal interpretation, the reader should name that crossing instead of flattening the categories.',
        ],
      },
      {
        id: 'understanding-controlling-text-evidence',
        title: 'Controlling Text Legal Evidence',
        body: [
          'Ownership in Understanding Controlling Text is not the same as display. A consumer can show, store, or report a value while the controlling boundary remains the root LICENSE, third-party license files, public policy files, issue templates, and controlling legal text. Understanding Controlling Text uses the fact as legal evidence evidence, then keeps the explanation inside Legal rather than turning it into a project-wide claim. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Legal Evidence.',
          'Adjacent pages matter for Understanding Controlling Text, but adjacency does not move authority. Understanding Controlling Text should be compared with Understanding License Authority, Including License Text, Understanding Original Materials only when the reader has moved to that neighboring subject. The reader should switch pages only when the subject has changed.',
          'Use legal evidence to keep Understanding Controlling Text tied to License Authority and Materials; use a related page only when the reader needs a different owner.',
        ],
      },
      {
        id: 'understanding-controlling-text-related-legal',
        title: 'Controlling Text Related Legal',
        body: [
          'Use ordinary use to keep Understanding Controlling Text tied to License Authority and Materials; use a related page only when the reader needs a different owner. The point matters in related legal because reading rights from controlling text can otherwise be mistaken for expanding permissions through explanatory wording. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Related Legal.',
          'The public boundary for Understanding Controlling Text is part of the article, not an afterthought. It does not grant extra permission, waive restrictions, replace the controlling text, or provide legal advice. This wording keeps public documentation from expanding permission or asking for unsafe evidence.',
          'The useful result of Understanding Controlling Text related legal is a bounded explanation of license interpretation: enough detail to act, and enough restraint to avoid claims outside Authority Text.',
        ],
      },
      {
        id: 'understanding-controlling-text-reader-risk',
        title: 'Controlling Text Reader Risk',
        body: [
          'For legal decisions, read the LICENSE and the applicable third-party license files directly. Do not rely on a website article as legal permission. The fact also tells the reader which evidence to preserve for reader risk: the exact public legal text, affected material category, proposed use, restriction, third-party status, and whether the question concerns ordinary use or a restricted use. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Reader Risk.',
          'An operator reading Understanding Controlling Text should follow legal reading starts with material classification, moves to controlling text, and keeps summaries subordinate to the legal source. That order prevents a visible result from being treated as the first source of truth.',
          'Use reader risk to keep Understanding Controlling Text tied to License Authority and Materials; use a related page only when the reader needs a different owner.',
        ],
      },
      {
        id: 'understanding-controlling-text-non-advice',
        title: 'Controlling Text Non-Advice Boundary',
        body: [
          'Visible feedback for Understanding Controlling Text should be read as evidence, not as a complete diagnosis. The next step is to connect the feedback to the owner and to the category path Legal / License Authority and Materials / Authority Text. Understanding Controlling Text uses the fact as non-advice boundary evidence, then keeps the explanation inside Legal rather than turning it into a project-wide claim. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Non-Advice Boundary.',
          'Implementation limits for Understanding Controlling Text keep the article tied to confirmed behavior. If a command, backend, schema branch, or policy file is not part of this topic, the page should not use it as proof.',
          'Use non-advice boundary to keep Understanding Controlling Text tied to License Authority and Materials; use a related page only when the reader needs a different owner.',
        ],
      },
      {
        id: 'understanding-controlling-text-public-summary',
        title: 'Controlling Text Public Summary',
        body: [
          'The English license text controls Ludoxel original materials. Other explanatory pages are orientation material and should be consistent with that text. In Understanding Controlling Text, public summary is the difference between reading license interpretation and assuming authority from a nearby surface, file, or policy summary. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Public Summary.',
          'The summary value of Understanding Controlling Text is precision. It tells the reader what the topic covers, which owner controls it, and which evidence is enough for a public explanation.',
          'If the available evidence for public summary does not identify the root LICENSE, third-party license files, public policy files, issue templates, and controlling legal text, Understanding Controlling Text should be treated as an observation rather than a confirmed cause.',
        ],
      },
      {
        id: 'understanding-controlling-text-closing-check',
        title: 'Controlling Text Closing Check',
        body: [
          'Authority Scope defines the useful size of Understanding Controlling Text. The article should be broad enough to explain license interpretation, but narrow enough that expanding permissions through explanatory wording remains outside the conclusion. The fact also tells the reader which evidence to preserve for closing check: the exact public legal text, affected material category, proposed use, restriction, third-party status, and whether the question concerns ordinary use or a restricted use. The local reading frame is Understanding Controlling Text / License Authority and Materials / Authority Text / Closing Check.',
          'A final check for Understanding Controlling Text should confirm the category, owner, evidence, and boundary. If any one of those is missing, the conclusion should remain narrower than the symptom.',
          'Use closing check to keep Understanding Controlling Text tied to License Authority and Materials; use a related page only when the reader needs a different owner.',
        ],
      },
    ],
