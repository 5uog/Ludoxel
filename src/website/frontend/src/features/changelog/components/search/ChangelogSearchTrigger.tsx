...
export default function ChangelogSearchTrigger({ onOpen }: ChangelogSearchTriggerProps): React.JSX.Element {
  return (
    <button
      ...
      className="search-bar-gradient-border inline-flex w-full max-w-150 cursor-pointer items-center justify-between gap-3 bg-accent/5 py-4 pl-4 pr-4 transition-colors hover:bg-accent/10 md:gap-5 md:pl-8"
      type="button"
      onClick={onOpen}
    >
