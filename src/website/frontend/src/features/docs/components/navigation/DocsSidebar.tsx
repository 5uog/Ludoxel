...
import { findActiveSidebarSectionTitle, isSidebarItemActive } from '../../lib/docsNavigationState';
                      ...
                      {section.items.map((item) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <DocsSidebarIcon className={isActive ? 'h-4 w-4 shrink-0 text-foreground' : 'h-4 w-4 shrink-0'} icon={item.icon} />
