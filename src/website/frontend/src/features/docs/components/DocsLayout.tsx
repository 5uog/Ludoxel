...
import { type DocsLayoutProps } from '../types/docsLayout.types';
import { getDocsContentWidthClassName, getDocsLayoutClassName, getDocsLayoutView } from '../lib/docsLayoutView';
import { useDocsFooterOverlap } from '../hooks/useDocsFooterOverlap';
import { useDocsMobileSidebar } from '../hooks/useDocsMobileSidebar';
