...
SPECIAL_DIRT_TYPES: tuple[StoneType, ...] = (
    StoneType(key="crimson_nylium", display="Crimson Nylium", textures=side_top_bottom_textures("crimson_nylium_side", "crimson_nylium", "netherrack")),
    StoneType(key="warped_nylium", display="Warped Nylium", textures=side_top_bottom_textures("warped_nylium_side", "warped_nylium", "netherrack")),
    ...
    StoneType(key="rooted_dirt", display="Rooted Dirt", textures=cube_textures("rooted_dirt")),
    StoneType(key="farmland", display="Farmland", textures=side_top_bottom_textures("farmland_side", "farmland_dry", "dirt"), kind="short_cube", is_full_cube=False),
