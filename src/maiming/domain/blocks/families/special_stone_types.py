...
SPECIAL_STONE_TYPES: tuple[StoneType, ...] = (
    ...
    StoneType(key="honeycomb_block", display="Honeycomb Block", textures=cube_textures("honeycomb_block")),
    ...
    StoneType(key="prismarine", display="Prismarine", textures=cube_textures("prismarine_rough"), slab_key="prismarine_slab", stairs_key="prismarine_stairs"),
