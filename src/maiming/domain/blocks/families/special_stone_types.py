# FILE: src/maiming/domain/blocks/families/special_stone_types.py
from __future__ import annotations

from maiming.domain.blocks.families.stone_types import (
    StoneType,
    cube_textures,
    side_top_bottom_textures,
    column_textures,
)
...
SPECIAL_STONE_TYPES: tuple[StoneType, ...] = (
    StoneType(
        ...
        slab_key="cobblestone_slab",
        stairs_key="cobblestone_stairs",
        wall_key="cobblestone_wall",
    ),
    StoneType(
    ...
    StoneType(
        ...
        textures=cube_textures("resin_block"),
    ),
    StoneType(
        key="resin_bricks",
    ...
    StoneType(
        key="chiseled_resin_bricks",
        display="Chiseled Resin Bricks",
        textures=cube_textures("chiseled_resin_bricks"),
    ),
    StoneType(
        key="nether_bricks",
    ...
    StoneType(
        key="chiseled_nether_bricks",
        display="Chiseled Nether Bricks",
        textures=cube_textures("chiseled_nether_bricks"),
    ),
    StoneType(
        key="cracked_nether_bricks",
        display="Cracked Nether Bricks",
        textures=cube_textures("cracked_nether_bricks"),
    ),
    StoneType(
        key="netherite_block",
        display="Block of Netherite",
        textures=cube_textures("netherite_block"),
    ),
    StoneType(
        key="lodestone",
        display="Lodestone",
        textures=side_top_bottom_textures("lodestone_side", "lodestone_top", "lodestone_top"),
    ),
    StoneType(
        key="purpur_block",
        display="Purpur Block",
        textures=cube_textures("purpur_block"),
        slab_key="purpur_slab",
        stairs_key="purpur_stairs",
    ),
    StoneType(
        key="purpur_pillar",
        display="Purpur Pillar",
        textures=column_textures("purpur_pillar", "purpur_pillar_top"),
    ),
    StoneType(
        key="honeycomb_block",
        display="Honeycomb Block",
        textures=cube_textures("honeycomb_block"),
    ),
    StoneType(
        key="dark_prismarine",
        display="Dark Prismarine",
        textures=cube_textures("prismarine_dark"),
        slab_key="dark_prismarine_slab",
        stairs_key="dark_prismarine_stairs",
    ),
    StoneType(
        key="prismarine_bricks",
        display="Prismarine Bricks",
        textures=cube_textures("prismarine_bricks"),
        slab_key="prismarine_brick_slab",
        stairs_key="prismarine_brick_stairs",
    ),
    StoneType(
        key="prismarine",
        display="Prismarine",
        textures=cube_textures("prismarine_rough"),
        slab_key="prismarine_slab",
        stairs_key="prismarine_stairs",
    ),
    StoneType(
        key="quartz_block",
        display="Block of Quartz",
        textures=side_top_bottom_textures("quartz_block_side", "quartz_block_top", "quartz_block_bottom"),
    ),
    StoneType(
        key="quartz_bricks",
        display="Quartz Bricks",
        textures=cube_textures("quartz_bricks"),
    ),
    StoneType(
        key="quartz_pillar",
        display="Quartz Pillar",
        textures=column_textures("quartz_column_side", "quartz_column_top"),
    ),
    StoneType(
    ...
    StoneType(
        ...
        textures=cube_textures("smooth_quartz"),
        slab_key="smooth_quartz_slab",
        stairs_key="smooth_quartz_stairs",
    ),
    ...
    StoneType(key="magma_block", display="Magma Block", textures=cube_textures("magma")),
