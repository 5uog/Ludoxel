# FILE: src/maiming/domain/blocks/families/ore_types.py
from __future__ import annotations

from maiming.domain.blocks.families.stone_types import StoneType, cube_textures, column_textures
...
ORE_TYPES: tuple[StoneType, ...] = (
    ...
    StoneType(
        ...
        textures=column_textures("ancient_debris_side", "ancient_debris_top"),
    ),
    StoneType(
        key="deepslate_iron_ore",
        display="Deepslate Iron Ore",
        textures=cube_textures("deepslate_iron_ore"),
    ),
    StoneType(
        key="deepslate_gold_ore",
        display="Deepslate Gold Ore",
        textures=cube_textures("deepslate_gold_ore"),
    ),
    StoneType(
        key="deepslate_diamond_ore",
        display="Deepslate Diamond Ore",
        textures=cube_textures("deepslate_diamond_ore"),
    ),
    StoneType(
        key="deepslate_lapis_ore",
        display="Deepslate Lapis Ore",
        textures=cube_textures("deepslate_lapis_ore"),
    ),
    StoneType(
        key="deepslate_redstone_ore",
        display="Deepslate Redstone Ore",
        textures=cube_textures("deepslate_redstone_ore"),
    ),
    StoneType(
        key="deepslate_emerald_ore",
        display="Deepslate Emerald Ore",
        textures=cube_textures("deepslate_emerald_ore"),
    ),
    StoneType(
        key="deepslate_coal_ore",
        display="Deepslate Coal Ore",
        textures=cube_textures("deepslate_coal_ore"),
    ),
    StoneType(
        key="deepslate_copper_ore",
        display="Deepslate Copper Ore",
        textures=cube_textures("deepslate_copper_ore"),
    ),
)