...
from .stone_types import StoneType, cube_textures
...
DECORATIVE_STONE_TYPES: tuple[StoneType, ...] = (
    ...
    StoneType(key="smooth_stone", display="Smooth Stone", textures=cube_textures("smooth_stone"), slab_key="smooth_stone_slab"),
    ...
    StoneType(key="chiseled_tuff", display="Chiseled Tuff", textures=cube_textures("chiseled_tuff")),
    StoneType(key="chiseled_tuff_bricks", display="Chiseled Tuff Bricks", textures=cube_textures("chiseled_tuff_bricks")),
)