# FILE: src/maiming/domain/blocks/families/stone_types.py
from __future__ import annotations

from dataclasses import dataclass

from maiming.domain.blocks.block_definition import BlockTextures
...
STONE_TYPES: tuple[StoneType, ...] = (
    StoneType(
        key="stone",
        display="Stone",
        textures=cube_textures("stone"),
        slab_key="stone_slab",
        stairs_key="stone_stairs",
    ),
    StoneType(
        key="granite",
        display="Granite",
        textures=cube_textures("stone_granite"),
        slab_key="granite_slab",
        stairs_key="granite_stairs",
        wall_key="granite_wall",
    ),
    StoneType(
        key="diorite",
        display="Diorite",
        textures=cube_textures("stone_diorite"),
        slab_key="diorite_slab",
        stairs_key="diorite_stairs",
        wall_key="diorite_wall",
    ),
    StoneType(
        key="andesite",
        display="Andesite",
        textures=cube_textures("stone_andesite"),
        slab_key="andesite_slab",
        stairs_key="andesite_stairs",
        wall_key="andesite_wall",
    ),
    StoneType(
        key="blackstone",
        display="Blackstone",
        textures=cube_textures("blackstone"),
        slab_key="blackstone_slab",
        stairs_key="blackstone_stairs",
        wall_key="blackstone_wall",
    ),
    StoneType(
        key="deepslate",
        display="Deepslate",
        textures=side_top_bottom_textures("deepslate", "deepslate_top", "deepslate_top"),
    ),
    StoneType(
        key="tuff",
        display="Tuff",
        textures=cube_textures("tuff"),
        slab_key="tuff_slab",
        stairs_key="tuff_stairs",
        wall_key="tuff_wall",
    ),
    StoneType(
        key="basalt",
        display="Basalt",
        textures=column_textures("basalt_side", "basalt_top"),
    ),
    StoneType(
        key="polished_granite",
        display="Polished Granite",
        textures=cube_textures("stone_granite_smooth"),
        slab_key="polished_granite_slab",
        stairs_key="polished_granite_stairs",
    ),
    StoneType(
        key="polished_diorite",
        display="Polished Diorite",
        textures=cube_textures("stone_diorite_smooth"),
        slab_key="polished_diorite_slab",
        stairs_key="polished_diorite_stairs",
    ),
    StoneType(
        key="polished_andesite",
        display="Polished Andesite",
        textures=cube_textures("stone_andesite_smooth"),
        slab_key="polished_andesite_slab",
        stairs_key="polished_andesite_stairs",
    ),
    StoneType(
    ...
    StoneType(
        ...
        textures=column_textures("polished_basalt_side", "polished_basalt_top"),
    ),
    StoneType(
        key="smooth_basalt",
        display="Smooth Basalt",
        textures=cube_textures("smooth_basalt"),
    ),
)