...
class PersistedInventory:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {"creative_hotbar_slots": [str(v) for v in creative_slots], "creative_selected_hotbar_index": int(creative_idx), "survival_hotbar_slots": [str(v) for v in survival_slots], "survival_selected_hotbar_index": int(survival_idx)}
    ...
    def from_dict(d: dict[str, Any]) -> "PersistedInventory":
        ...
        return PersistedInventory(creative_hotbar_slots=creative_slots, creative_selected_hotbar_index=int(creative_idx), survival_hotbar_slots=survival_slots, survival_selected_hotbar_index=int(survival_idx))
