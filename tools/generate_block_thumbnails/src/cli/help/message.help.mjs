    ...
    sections: Object.freeze([
      ...
      Object.freeze({
        ...
        lines: Object.freeze([
          ...
          'fence と wall で --neighbor がない場合は、代表 thumbnail として north-south の同種 neighbor context を使う。',
      ...
      Object.freeze({
        ...
        lines: Object.freeze([
          ...
          'npm run assets:block-thumbnails:check -- --block minecraft:oak_fence --neighbor north=minecraft:oak_fence --neighbor south=minecraft:oak_fence --texture-root assets/minecraft/textures/ --output-root assets/ludoxel/thumbnails/blocks/',
          'npm run assets:block-thumbnails:generate -- --block minecraft:stone_brick_wall --neighbor north=minecraft:stone_brick_wall --neighbor south=minecraft:stone_brick_wall --texture-root assets/minecraft/textures/ --output-root assets/ludoxel/thumbnails/blocks/ --allow-overwrite',
        ]),
      }),
    ]),
  }),
    ...
    sections: Object.freeze([
      ...
      Object.freeze({
        ...
        lines: Object.freeze([
          ...
          '--fit-padding PX             Transparent padding. Default is 36.',
      ...
      Object.freeze({
        ...
        lines: Object.freeze([
          ...
          'When fence or wall has no --neighbor option, the representative thumbnail uses same-block north-south neighbor context.',
