# FILE: infrastructure/platform/qtInputAdapter.py
...
class QtInputAdapter(QObject):
    ...
    def reset(self) -> None:
        # Clears all latched inputs to avoid "stuck" movement across pause/resume.
        self._keys.clear()
    ...
    def consume(self) -> InputFrame:
        ...
        jump_pressed = bool(jump_held) or bool(self._jump_queued)
